...
```
```
~Lv2~{"Name":"Mean Thrash","Group":"Deep Dungeon","ZoneLockH":[1099,1100,1101,1102,1103,1104,1105,1106,1107,1108,1124],"ElementsL":[{"Name":"Mean Thrash","type":4,"radius":2.1,"coneAngleMin":-45,"coneAngleMax":45,"refActorNPCNameID":12127,"refActorRequireCast":true,"refActorCastId":[1279,2781,3345,5209,8005,10689,13982,14944,28031,32403],"refActorComparisonType":6,"includeHitbox":true,"includeRotation":true,"AdditionalRotation":3.1415927,"Filled":true}]}
```
```
